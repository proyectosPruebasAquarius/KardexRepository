...
class HistorialInventario extends Component
{
    ...
    public function render()
    {
        ...
        $this->detalle = DetalleInventariosModel::leftJoin('documentos','documentos.id','=','detalles_inventarios.id_documento')->leftJoin('tipos_documentos','tipos_documentos.id','=','documentos.id_tipo_documento')
