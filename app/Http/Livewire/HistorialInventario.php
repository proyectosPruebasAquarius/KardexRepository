...
class HistorialInventario extends Component
{
    ...
    public function render()
    {
        ...
        $this->detalle = DetalleInventariosModel::select('precio_unitario','concepto','cantidad_saldo','cantidad_entrada','cantidad_salida','total_saldo','total_entrada','total_salida','fecha_registro')
