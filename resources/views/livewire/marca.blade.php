<div>
    <div id="marcaModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="marcaModalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="createData" id="marcaForm">
                ...
                <div class="modal-footer col-12">
                    ...
                    <button type="submit" class="btn  btn-primary" form="marcaForm">
                        @if ($id_marca)
                        Actualizar
                        @else
                        Guardar
...
@push('scripts')
<script>
    let modal = document.getElementById('marcaModal');

        modal.addEventListener('hide.bs.modal',function(){
            Livewire.emit('resetNames');
        }) ;
</script>
@endpush